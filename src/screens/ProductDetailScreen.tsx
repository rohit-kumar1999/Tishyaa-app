...
export default function ProductDetailScreen() {
  ...
  const product = {
    ...
    description: 'Exquisite diamond pendant set crafted with precision and elegance. Perfect for special occasions and everyday wear.',
    price: 25000,
    originalPrice: 30000,
    images: [
      ...
      <View style={styles.productInfo}>
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.wishlistButton}>
            <Ionicons name="heart-outline" size={24} color="#C9A961" />
          </TouchableOpacity>
        </View>
